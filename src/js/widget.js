...
(function() {
    ...
    var icons = {};
    if (window.params.icons) {
        try {
            icons = JSON.parse(window.params.icons);
        } catch (e) {
            icons = {};
        }
    }
    ...
    if (window.params.tools) {
        try {
            var t = JSON.parse(window.params.tools);
            tools = t;
        } catch (e) {}
    }
    ...
    (function() {
        ...
        window.selectBtn = function(btn, isSkipWebRTCMessage) {
            ...
            if (!isSkipWebRTCMessage && window.connection && connection.numberOfConnectedUsers >= 1) {
                connection.returnConnection().connection.send({
                    btnSelected: btn.id
                });
            } else {
